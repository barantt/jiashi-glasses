...
const ogSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <!-- 右侧眼镜插画 -->
  <circle cx="902" cy="330" r="196" fill="none" stroke="#58b925" stroke-opacity="0.28" stroke-width="2"/>
  <circle cx="902" cy="330" r="176" fill="none" stroke="#58b925" stroke-opacity="0.18" stroke-width="1.5" stroke-dasharray="3 10"/>
  <g transform="rotate(-5 902 330)">
    ...
    <path d="M706 350l36-30M1002 350l36-30" stroke="#58b925" stroke-width="6" stroke-linecap="round"/>
    <circle cx="656" cy="296" r="8" fill="#58b925"/>
    <circle cx="1148" cy="296" r="8" fill="#58b925"/>
  </g>

  <!-- 金色星点 -->
  <g stroke="#58b925" stroke-width="4" stroke-linecap="round">
