...
const ogSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <rect x="28" y="28" width="1144" height="574" rx="24" fill="none" stroke="#d4af37" stroke-opacity="0.55" stroke-width="2"/>

  <!-- 左侧文案 -->
  <text x="80" y="168" font-family="Outfit" font-size="30" letter-spacing="9" fill="#d4af37">JIASHI OPTICAL · EST. 2012</text>
  <text x="76" y="300" font-family="Noto Serif SC" font-weight="700" font-size="132" fill="#fcfbf8">佳视眼镜</text>
  <text x="80" y="404" font-family="Noto Serif SC" font-weight="700" font-size="58" fill="#d4af37">看清世界，从佳视开始</text>
  ...
  <!-- 右侧眼镜插画 -->
  <circle cx="902" cy="330" r="196" fill="none" stroke="#d4af37" stroke-opacity="0.28" stroke-width="2"/>
  <circle cx="902" cy="330" r="176" fill="none" stroke="#d4af37" stroke-opacity="0.18" stroke-width="1.5" stroke-dasharray="3 10"/>
  <g transform="rotate(-5 902 330)">
    ...
    <path d="M706 350l36-30M1002 350l36-30" stroke="#d4af37" stroke-width="6" stroke-linecap="round"/>
    <circle cx="656" cy="296" r="8" fill="#d4af37"/>
    <circle cx="1148" cy="296" r="8" fill="#d4af37"/>
  </g>

  <!-- 金色星点 -->
  <g stroke="#d4af37" stroke-width="4" stroke-linecap="round">
